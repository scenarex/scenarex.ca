      ...
      <div className="row w-full">
              ...
              <ul>
                {page.column1_items.map(item => (
                  <li key={item.item_label}>
                    <Link to={`/${lang}/${item.item_url.uid}`}>
                      {item.item_label}
                    </Link>
                  </li>
                ))}
        ...
        <div className="w-full">
          ...
          <form
            action={
              lang === 'en'
                ? 'https://scenarex.us14.list-manage.com/subscribe/post?u=55adcdb3618aefdb354ae8f92&amp;id=b554781cb8&SIGNUP=SCENAREX-' +
                  lang
                : 'https://scenarex.us14.list-manage.com/subscribe/post?u=55adcdb3618aefdb354ae8f92&amp;id=ec466ad45e&SIGNUP=SCENAREX-' +
                  lang
            }
            method="post"
          ...
          >
            ...
            >
              <input
                type="text"
                name="b_55adcdb3618aefdb354ae8f92_b554781cb8"
                tabIndex="-1"
                defaultValue=""
              />
            </div>
            <div className="clear md:w-3/12 w-full ml-0">
              <button
                className="button bg-mastheadColor"
                type="submit"
                value="Subscribe"
                name="subscribe"
