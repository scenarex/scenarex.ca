...
const NewsPage = ({ data }) => {
  ...
  return (
  <Layout title={pageData.title[0].text} path={pageData._meta.uid} alternate={pageData._meta.alternateLanguages[0].uid} headerData={data.headerData} footerData={data.footerData}>
    <main>
